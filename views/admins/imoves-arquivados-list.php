                ...
                <div class="text-start">
                    ...
                    <div class="btn-group">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item editar"><i class="fa-solid fa-pen"></i> Editar</a>
                            <a class="dropdown-item desarquivar" data-id="<?= $imovel->id ?>"><i class="fa-solid fa-box-archive"></i> Desarquivar</a>
